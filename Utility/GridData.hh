...
public:
    ...
    /// placeholder for interchange with GridDataWithXAxis
    void xshift(double) { }
};

/// Grid data with x axis information
template<class GD>
class GridDataWithXAxis: public GD {
public:
    ...
    /// x bin position
    double binX(int i) const { return t0 + i*dt; }
    ...
    /// set axis from another GridData
    template<class GD2>
    void setAxisFrom(const GD2& v) { t0 = v.t0; dt = v.dt; s_start = v.s_start; }
