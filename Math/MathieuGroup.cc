...
namespace MathieuGroup {
    ...
    const M11_mrepr_t M11ma   {{0,2,0,1,1,
                                2,1,1,0,2,
                                1,1,1,2,2,
                                0,2,2,2,2,
                                0,2,2,1,0 }};

    const M11_mrepr_t M11mb   {{0,1,1,0,1,
                                2,0,0,1,0,
                                0,0,1,2,2,
                                2,1,0,0,0,
                                0,1,2,2,1 }};

    const M11_repr_t M11a({1,10,3,11,7,6,5,9,8,2,4},1);
    const M11_repr_t M11b({4,5,8,3,6,9,7,1,2,10,11},1);

    const M11_genspan_t& M11() {
        static const M11_genspan_t M11({M11a,M11b});
        return M11;
    }

    const M11_conj_t& M11_conj() {
        static const M11_conj_t C(M11());
        return C;
    }

    const M11_cayley_t& M11_CT() {
        static const M11_cayley_t CT(M11());
        return CT;
    }
    ...
    const M12_genspan_t& M12() {
        static const M12_genspan_t M12({M12a,M12b});
        return M12;
    }
    ...
    const M21_genspan_t& M21() {
        static const M21_genspan_t M21({M21a,M21b});
        return M21;
    }
    ...
    const M22_repr_t M22b({21,17,20,12,11,10,14,13,8,7,6,4,1,19,5,15,18,3,16,9,0,2});
        ...
        static const M22_genspan_t M22({M22a,M22b});
        return M22;
    }
}
